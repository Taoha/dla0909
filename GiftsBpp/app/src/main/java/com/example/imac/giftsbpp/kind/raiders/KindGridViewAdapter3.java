...
public class KindGridViewAdapter3 extends BaseAdapter {
    private KindGridViewBean bean;
    private Context context;

    public KindGridViewAdapter3(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        Picasso.with(context).load(bean.getData().getChannel_groups().get(2).getChannels().get(i).getCover_image_url()).into(hodler.avatar);
